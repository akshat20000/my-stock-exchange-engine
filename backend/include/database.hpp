...
public:
    ...
    crow::json::wvalue getUserByUsername(const std::string &username);
    crow::json::wvalue getUserById(int user_id);
    bool updateUserBalance(int user_id, double new_balance);
};
