...
void Server::setup_routes()
{
    ...
    CROW_ROUTE(app_, "/trades").methods("GET"_method)([this]()
                                                      { return this->handle_get_trades(); });

    // ✅ GET /orderbook/<symbol>
    CROW_ROUTE(app_, "/orderbook/<string>").methods("GET"_method)([this](const std::string &symbol)
...
crow::response Server::handle_get_trades()
{
    ...
    return crow::response(200, db_.getRecentTrades());
}
